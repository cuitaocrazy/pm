...
export default function access(initialState: { currentUser?: API.CurrentUser | undefined }) {
  ...
  return {
    ...
    canProjEdit: hasPower([
      'realm:supervisor',
      'realm:group_leader',
      'realm:project_manager',
      'realm:marketer',
    ]),
    canProLeaderEdit: hasPower(['realm:project_leader']),
    canEditSalesActive: hasPower([
      'realm:supervisor',
      'realm:group_leader',
      'realm:project_manager',
      'realm:assistant',
    ...
    canEditAfterSalesActive: hasPower([
      'realm:supervisor',
      'realm:group_leader',
      'realm:project_manager',
      'realm:assistant',
    ...
    canProjDailies: hasPower([
      'realm:supervisor',
      'realm:group_leader',
      'realm:project_manager',
      'realm:marketer',
    ]),
    canProjWeeklies: hasPower([
      'realm:supervisor',
      'realm:group_leader',
      'realm:project_manager',
      'realm:marketer',
    ]),
    canProjExpense: hasPower([
      'realm:supervisor',
      'realm:group_leader',
      'realm:project_manager',
      'realm:marketer',
