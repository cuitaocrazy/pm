...
export default function access(initialState: { currentUser?: API.CurrentUser | undefined }) {
  ...
  return {
    ...
    canSynt: hasPower(['realm:supervisor', 'realm:group_leader', 'realm:project_manager', 'realm:assistant']),
    canSyntEdit: hasPower(['realm:supervisor', 'realm:group_leader', 'realm:project_manager', 'realm:assistant']),
    canSyntDailies: hasPower(['realm:supervisor', 'realm:group_leader', 'realm:project_manager', 'realm:assistant']),
    canMarket: hasPower(['realm:supervisor', 'realm:marketer']),
    canMarketCustom: hasPower(['realm:supervisor', 'realm:marketer']),
    canMarketPlan: hasPower(['realm:supervisor', 'realm:marketer']),
