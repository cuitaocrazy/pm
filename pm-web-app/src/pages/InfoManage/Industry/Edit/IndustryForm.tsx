...
import type { IndustryInput } from '@/apollo';
...
export default (form: FormInstance<IndustryInput>, data?: IndustryInput) => {
  return (
    <Form {...layout} form={form} initialValues={data}>
      <Form.Item label="ID" name="id" hidden>
        <Input />
      </Form.Item>
      <Form.Item label="行业名称" name="name" rules={[{ required: true }]}>
        <Input />
      </Form.Item>
      <Form.Item label="行业编码" name="code" rules={[{ required: true }]}>
