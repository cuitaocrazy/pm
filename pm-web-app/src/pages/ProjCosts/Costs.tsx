...
import type { EmployeeCost } from '@/apollo';
    ...
    () => [
      {
        ...
        onFilter: (value: string | number | boolean, record: EmployeeCost) =>
          R.equals(value, record.user.id),
      },
      {
        title: '金额(元)',
        dataIndex: 'amount',
      ...
      },
      {
        ...
        sorter: {
          compare: (a: EmployeeCost, b: EmployeeCost) =>
            R.subtract(
